...
public class StaticColorShader extends Shader{
	
	private static final String VERTEX_FILE = "./shaders/StaticColorVertex.vs",
								FRAGMENT_FILE = "./shaders/StaticColorFragment.fs";
	...
	public StaticColorShader(Matrix4f projection) {
